...
fetch('data.json')
    ...
    .then(data => {
        RadioElements['Radio1'].addEventListener('click', function(){ ChangeRadio(1);});
        RadioElements['Radio2'].addEventListener('click', function(){ ChangeRadio(2);});
        RadioElements['Radio3'].addEventListener('click', function(){ ChangeRadio(3);});
        RadioElements['Radio4'].addEventListener('click', function(){ ChangeRadio(4);});
