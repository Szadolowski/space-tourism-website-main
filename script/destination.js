...
fetch("data.json")
  ...
  .then((data) => {
    NavElements["Nav1"].addEventListener("click", function () {
      ChangeNav(1);
    });
    NavElements["Nav2"].addEventListener("click", function () {
      ChangeNav(2);
    });
    NavElements["Nav3"].addEventListener("click", function () {
      ChangeNav(3);
    });
    NavElements["Nav4"].addEventListener("click", function () {
      ChangeNav(4);
    });
    ...
    function ChangeNav(id) {
      ...
      Distance.innerHTML =
        data["destinations"][id - 1]["distance"].toUpperCase();
